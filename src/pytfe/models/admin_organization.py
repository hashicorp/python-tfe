...
class AdminOrganization(BaseModel):
    ...
    fair_run_queuing_enabled: bool | None = Field(default=None, alias="fair-run-queuing-enabled")
    owners_team_saml_role_id: str | None = Field(default=None, alias="owners-team-saml-role-id")
    two_factor_conformant: bool | None = Field(default=None, alias="two-factor-conformant")
    global_module_sharing: bool | None = Field(default=None, alias="global-module-sharing")
    global_provider_sharing: bool | None = Field(default=None, alias="global-provider-sharing")
